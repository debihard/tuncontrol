...
# Tun Control
#
# Install: cd /usr/local/bin && wget -O xtun https://raw.githubusercontent.com/debihard/tuncontrol/master/tun.sh && chmod +x xtun
#
# Usage: xtun
#
while true
...
kill $(ps aux | grep '[s]sh -o StrictHostKeychecking=no -o ConnectTimeout=10 -o UserKnownHostsFile=/dev/null -fCN -D 50001' | awk '{print $2}') 2> /dev/null
kill $(ps aux | grep '[s]sh -o StrictHostKeychecking=no -o ConnectTimeout=10 -o UserKnownHostsFile=/dev/null -fCN -D 50002' | awk '{print $2}') 2> /dev/null
kill $(ps aux | grep '[s]sh -o StrictHostKeychecking=no -o ConnectTimeout=10 -o UserKnownHostsFile=/dev/null -fCN -D 50003' | awk '{print $2}') 2> /dev/null
kill $(ps aux | grep '[s]sh -o StrictHostKeychecking=no -o ConnectTimeout=10 -o UserKnownHostsFile=/dev/null -fCN -D 50004' | awk '{print $2}') 2> /dev/null
kill $(ps aux | grep '[s]sh -o StrictHostKeychecking=no -o ConnectTimeout=10 -o UserKnownHostsFile=/dev/null -fCN -D 50005' | awk '{print $2}') 2> /dev/null
kill $(ps aux | grep '[s]sh -o StrictHostKeychecking=no -o ConnectTimeout=10 -o UserKnownHostsFile=/dev/null -fCN -D 50006' | awk '{print $2}') 2> /dev/null
kill $(ps aux | grep '[s]sh -o StrictHostKeychecking=no -o ConnectTimeout=10 -o UserKnownHostsFile=/dev/null -fCN -D 50007' | awk '{print $2}') 2> /dev/null
kill $(ps aux | grep '[s]sh -o StrictHostKeychecking=no -o ConnectTimeout=10 -o UserKnownHostsFile=/dev/null -fCN -D 50008' | awk '{print $2}') 2> /dev/null
kill $(ps aux | grep '[s]sh -o StrictHostKeychecking=no -o ConnectTimeout=10 -o UserKnownHostsFile=/dev/null -fCN -D 50009' | awk '{print $2}') 2> /dev/null
kill $(ps aux | grep '[s]sh -o StrictHostKeychecking=no -o ConnectTimeout=10 -o UserKnownHostsFile=/dev/null -fCN -D 50010' | awk '{print $2}') 2> /dev/null
}
#############################################################################################################
killall_threads_1(){
kill $(ps aux | grep '[1]-thread.sh' | awk '{print $2}') 2> /dev/null
...
kill $(ps aux | grep '[s]sh -o StrictHostKeychecking=no -o ConnectTimeout=10 -o UserKnownHostsFile=/dev/null -fCN -D 9401' | awk '{print $2}') 2> /dev/null
}
#############################################################################################################
show_socks_list(){
